/* =========================================================
   ARCVIEW STUDIO — SHARED HEADER & FOOTER
...
(function () {
  ...
  var EMAIL = "inquiry@arcviewstudio.com";

  var HEADER_HTML = `
  <header class="site-header" id="siteHeader">
    <div class="container header-inner">
      <a href="index.html" class="brand">
        <img src="logo.png" alt="Arcview Studio" class="mark">
        <span class="brand-text"><span class="brand-name">Arcview Studio</span><small>Shop Drawings &amp; 3D Visualization</small></span>
      </a>
      ...
      <div class="header-cta">
        ...
        <a href="contact.html" class="btn btn-primary btn-sm" id="quoteBtn"><i class="fa-regular fa-paper-plane quote-ic"></i><span class="btn-txt">Get a Quote</span></a>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <a href="index.html" class="brand">
            <img src="logo.png" alt="Arcview Studio" class="mark">
            <span>Arcview Studio</span>
          </a>
          <p>Arcview Studio delivers precise architectural, structural, MEP and joinery shop drawings plus photorealistic 3D design and rendering for clients across India and the Gulf.</p>
      ...
      <div class="footer-bottom">
        <p>&copy; <span id="footerYear"></span> Arcview Studio. All rights reserved.</p>
